        ...
        ************   Autocomplete   ************
        ...
        var Autocomplete = function (params) {
            ...
            if (a.params.input) {
                ...
                a.inputHidden = $(a.params.inputHidden);
                    ...
                    a.params.source(a, query, function (items) {
                        ...
                        for (i = 0; i < limit; i++) {
                            ...
                            itemsHTML += a.dropdownItemTemplate({
                                value: itemValue,
                                text: /*a.params.highlightMatches ? itemText.replace(regExp, '<b>$1</b>') :*/ jQuery.parseJSON(itemText).name
                            });
                        }
            ...
            function handleDropdownClick (e) {
                ...
                if (a.params.updateInputValueOnSelect) {
                    a.input.val(typeof clickedItem === 'object' ? clickedItem[a.params.textProperty] : jQuery.parseJSON(clickedItem).name);
                    a.inputHidden.val(typeof clickedItem === 'object' ? clickedItem[a.params.textProperty] : clickedItem);
